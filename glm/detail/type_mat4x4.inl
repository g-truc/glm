...
#	if GLM_CONFIG_DEFAULTED_DEFAULT_CTOR == GLM_DISABLE
		...
		GLM_DEFAULTED_DEFAULT_CTOR_QUALIFIER constexpr mat<4, 4, T, Q>::mat()
...
#	endif
	...
	GLM_FUNC_QUALIFIER constexpr mat<4, 4, T, Q>::mat(mat<4, 4, T, P> const& m)
...
#		endif
	...
	template<typename T, qualifier Q>
	GLM_FUNC_QUALIFIER constexpr mat<4, 4, T, Q>::mat(T s)
#		if GLM_HAS_INITIALIZER_LISTS
...
#		endif
	...
	template<typename T, qualifier Q>
	GLM_FUNC_QUALIFIER constexpr mat<4, 4, T, Q>::mat
	(
	...
	template<typename T, qualifier Q>
	GLM_FUNC_QUALIFIER constexpr mat<4, 4, T, Q>::mat(col_type const& v0, col_type const& v1, col_type const& v2, col_type const& v3)
#		if GLM_HAS_INITIALIZER_LISTS
...
#		endif
	...
	GLM_FUNC_QUALIFIER constexpr mat<4, 4, T, Q>::mat(mat<4, 4, U, P> const& m)
#		if GLM_HAS_INITIALIZER_LISTS
			: value{col_type(m[0]), col_type(m[1]), col_type(m[2]), col_type(m[3])}
#		endif
	{}
...
#		endif
	...
	GLM_FUNC_QUALIFIER constexpr mat<4, 4, T, Q>::mat(vec<4, V1, Q> const& v1, vec<4, V2, Q> const& v2, vec<4, V3, Q> const& v3, vec<4, V4, Q> const& v4)
#		if GLM_HAS_INITIALIZER_LISTS
...
#		endif
	...
	template<typename T, qualifier Q>
	GLM_FUNC_QUALIFIER constexpr mat<4, 4, T, Q>::mat(mat<2, 2, T, Q> const& m)
#		if GLM_HAS_INITIALIZER_LISTS
...
#		endif
	...
	template<typename T, qualifier Q>
	GLM_FUNC_QUALIFIER constexpr mat<4, 4, T, Q>::mat(mat<3, 3, T, Q> const& m)
#		if GLM_HAS_INITIALIZER_LISTS
...
#		endif
	...
	template<typename T, qualifier Q>
	GLM_FUNC_QUALIFIER constexpr mat<4, 4, T, Q>::mat(mat<2, 3, T, Q> const& m)
#		if GLM_HAS_INITIALIZER_LISTS
...
#		endif
	...
	template<typename T, qualifier Q>
	GLM_FUNC_QUALIFIER constexpr mat<4, 4, T, Q>::mat(mat<3, 2, T, Q> const& m)
#		if GLM_HAS_INITIALIZER_LISTS
...
#		endif
	...
	template<typename T, qualifier Q>
	GLM_FUNC_QUALIFIER constexpr mat<4, 4, T, Q>::mat(mat<2, 4, T, Q> const& m)
#		if GLM_HAS_INITIALIZER_LISTS
...
#		endif
	...
	template<typename T, qualifier Q>
	GLM_FUNC_QUALIFIER constexpr mat<4, 4, T, Q>::mat(mat<4, 2, T, Q> const& m)
#		if GLM_HAS_INITIALIZER_LISTS
			: value{col_type(m[0], 0, 0), col_type(m[1], 0, 0), col_type(0, 0, 1, 0), col_type(0, 0, 0, 1)}
#		endif
	{}
	...
	template<typename T, qualifier Q>
	GLM_FUNC_QUALIFIER constexpr mat<4, 4, T, Q>::mat(mat<3, 4, T, Q> const& m)
#		if GLM_HAS_INITIALIZER_LISTS
...
#		endif
	...
	template<typename T, qualifier Q>
	GLM_FUNC_QUALIFIER constexpr mat<4, 4, T, Q>::mat(mat<4, 3, T, Q> const& m)
#		if GLM_HAS_INITIALIZER_LISTS
...
#		endif
	...
	template<typename T, qualifier Q>
	GLM_FUNC_QUALIFIER constexpr typename mat<4, 4, T, Q>::col_type & mat<4, 4, T, Q>::operator[](typename mat<4, 4, T, Q>::length_type i) noexcept
	{
	...
	template<typename T, qualifier Q>
	GLM_FUNC_QUALIFIER constexpr typename mat<4, 4, T, Q>::col_type const& mat<4, 4, T, Q>::operator[](typename mat<4, 4, T, Q>::length_type i) const noexcept
	{
		GLM_ASSERT_LENGTH(i, this->length());
		return this->value[i];
	}
	...
	template<typename T, qualifier Q>
	template<typename U>
	GLM_FUNC_QUALIFIER constexpr mat<4, 4, T, Q>& mat<4, 4, T, Q>::operator=(mat<4, 4, U, Q> const& m)
	{
	...
	template<typename T, qualifier Q>
	template<typename U>
	GLM_FUNC_QUALIFIER constexpr mat<4, 4, T, Q>& mat<4, 4, T, Q>::operator+=(U s)
	{
		this->value[0] += s;
		this->value[1] += s;
		this->value[2] += s;
	...
	template<typename T, qualifier Q>
	GLM_FUNC_QUALIFIER constexpr mat<4, 4, T, Q> & mat<4, 4, T, Q>::operator++()
	{
		++this->value[0];
		++this->value[1];
		++this->value[2];
	...
	template<typename T, qualifier Q>
	GLM_FUNC_QUALIFIER constexpr mat<4, 4, T, Q> mat<4, 4, T, Q>::operator++(int)
	{
	...
	template<typename T, qualifier Q>
	GLM_FUNC_QUALIFIER constexpr mat<4, 4, T, Q> operator+(mat<4, 4, T, Q> const& m)
	{
		return m;
	}
	...
	template<typename T, qualifier Q>
	GLM_FUNC_QUALIFIER constexpr mat<4, 4, T, Q> operator+(mat<4, 4, T, Q> const& m, T scalar)
	{
		return mat<4, 4, T, Q>(
			m[0] + scalar,
			m[1] + scalar,
	...
	template<typename T, qualifier Q>
	GLM_FUNC_QUALIFIER constexpr mat<4, 4, T, Q> operator+(T scalar, mat<4, 4, T, Q> const& m)
	{
		return mat<4, 4, T, Q>(
			m[0] + scalar,
			m[1] + scalar,
	...
	template<typename T, qualifier Q>
	GLM_FUNC_QUALIFIER constexpr mat<4, 4, T, Q> operator+(mat<4, 4, T, Q> const& m1, mat<4, 4, T, Q> const& m2)
	{
		return mat<4, 4, T, Q>(
			m1[0] + m2[0],
			m1[1] + m2[1],
	...
	template<typename T, qualifier Q>
	GLM_FUNC_QUALIFIER constexpr typename mat<4, 4, T, Q>::col_type operator*
	(
		mat<4, 4, T, Q> const& m,
...
*/
	...
	template<typename T, qualifier Q>
	GLM_FUNC_QUALIFIER constexpr typename mat<4, 4, T, Q>::row_type operator*
	(
	...
	template<typename T, qualifier Q>
	GLM_FUNC_QUALIFIER constexpr mat<2, 4, T, Q> operator*(mat<4, 4, T, Q> const& m1, mat<2, 4, T, Q> const& m2)
	{
		return mat<2, 4, T, Q>(
	...
	template<typename T, qualifier Q>
	GLM_FUNC_QUALIFIER constexpr mat<3, 4, T, Q> operator*(mat<4, 4, T, Q> const& m1, mat<3, 4, T, Q> const& m2)
	{
		return mat<3, 4, T, Q>(
			m1[0][0] * m2[0][0] + m1[1][0] * m2[0][1] + m1[2][0] * m2[0][2] + m1[3][0] * m2[0][3],
			m1[0][1] * m2[0][0] + m1[1][1] * m2[0][1] + m1[2][1] * m2[0][2] + m1[3][1] * m2[0][3],
	...
	namespace detail
	{
		...
		{
			GLM_FUNC_QUALIFIER constexpr static mat<4, 4, T, Q> call(mat<4, 4, T, Q> const& m1, mat<4, 4, T, Q> const& m2)
			{
	...
	template<typename T, qualifier Q>
	GLM_FUNC_QUALIFIER constexpr typename mat<4, 4, T, Q>::col_type operator/(mat<4, 4, T, Q> const& m, typename mat<4, 4, T, Q>::row_type const& v)
	{
		return inverse(m) * v;
	}

	template<typename T, qualifier Q>
	GLM_FUNC_QUALIFIER constexpr typename mat<4, 4, T, Q>::row_type operator/(typename mat<4, 4, T, Q>::col_type const& v, mat<4, 4, T, Q> const& m)
	{
		return v * inverse(m);
	}
	...
	template<typename T, qualifier Q>
	GLM_FUNC_QUALIFIER constexpr bool operator==(mat<4, 4, T, Q> const& m1, mat<4, 4, T, Q> const& m2)
	{
