...
namespace glm
{
	...
	public:
		...
		GLM_CTOR_DECL mat(mat<1, 2, T, Q> const& x);
		GLM_CTOR_DECL mat(mat<2, 1, T, Q> const& x);
	...
	template<typename T, qualifier Q>
	GLM_FUNC_DECL GLM_CONSTEXPR mat<1, 2, T, Q> operator*(mat<4, 2, T, Q> const& m1, mat<1, 4, T, Q> const& m2);
