...
namespace detail
{
	...
	{
		GLM_FUNC_QUALIFIER constexpr static T call(vec<2, T, Q> const& v, vec<2, T, Q> const& u)
		{
	...
	GLM_FUNC_QUALIFIER constexpr T cross(vec<2, T, Q> const& x, vec<2, T, Q> const& y)
	{
