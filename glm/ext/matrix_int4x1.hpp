...
static_assert(std::is_trivially_default_constructible<glm::imat4x1>::value);
#endif
static_assert(std::is_trivially_copy_assignable<glm::imat4x1>::value);
static_assert(std::is_trivially_copyable<glm::imat4x1>::value);
static_assert(std::is_copy_constructible<glm::imat4x1>::value);
static_assert(glm::imat4x1::length() == 4);
