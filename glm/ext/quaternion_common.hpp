...
namespace glm
{
	...
	/// @tparam Q A value from qualifier enum
	template<typename T, qualifier Q>
	GLM_FUNC_DECL constexpr qua<T, Q> lerp(qua<T, Q> const& x, qua<T, Q> const& y, T a);
	...
	/// @tparam Q A value from qualifier enum
	template<typename T, qualifier Q>
	GLM_FUNC_DECL constexpr qua<T, Q> conjugate(qua<T, Q> const& q);
	...
	/// @tparam Q A value from qualifier enum
	template<typename T, qualifier Q>
	GLM_FUNC_DECL constexpr qua<T, Q> inverse(qua<T, Q> const& q);
