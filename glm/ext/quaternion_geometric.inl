namespace glm
{
	...
	GLM_FUNC_QUALIFIER constexpr T dot(qua<T, Q> const& x, qua<T, Q> const& y)
	{
	...
	template<typename T, qualifier Q>
	GLM_FUNC_QUALIFIER constexpr qua<T, Q> normalize(qua<T, Q> const& q)
	{
		T len = length(q);
	...
	template<typename T, qualifier Q>
	GLM_FUNC_QUALIFIER constexpr qua<T, Q> cross(qua<T, Q> const& q1, qua<T, Q> const& q2)
	{
		return qua<T, Q>::wxyz(
