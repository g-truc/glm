namespace glm
{
	...
	template<typename T, qualifier Q>
	GLM_FUNC_QUALIFIER constexpr qua<T, Q> lerp(qua<T, Q> const& x, qua<T, Q> const& y, T a)
	{
	...
	template<typename T, qualifier Q>
	GLM_FUNC_QUALIFIER constexpr qua<T, Q> conjugate(qua<T, Q> const& q)
	{
		return qua<T, Q>::wxyz(q.w, -q.x, -q.y, -q.z);
	}

	template<typename T, qualifier Q>
	GLM_FUNC_QUALIFIER constexpr qua<T, Q> inverse(qua<T, Q> const& q)
	{
